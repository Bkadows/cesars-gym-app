...
// 1. Define target category and daily values (June 1 - June 18)
const dailyTargets = {
  '2026-06-01': 350.00,
  '2026-06-02': 280.00,
  '2026-06-03': 320.00,
...
// Today's 48 entrances by hour (Friday, June 19)
const todayCheckinsByHour = {
  8: 9, 9: 4, 10: 3, 11: 0, 12: 2, 13: 3, 14: 5, 15: 12, 16: 2, 17: 6, 18: 2
};
...
// Add today's updated 50 transactions matching the 7:02 PM Caja Diaria report
...
const todayVentas = [
  ...
  // 12:00 checkins (2 checkins, plus 1 store sale)
  {
    id: `v_${vCounter++}`,
    customer: 'LUCERO',
    method: 'Efectivo',
  ...
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 12, 35),
    total: 4.00,
  ...
  // 14:00 checkins (5 checkins)
  {
    ...
    items: [
      ...
      { id: 'h2om', name: 'H2OM', cat: 'BEBIDA', qty: 1, price: 2.5 },
      { id: 'iso', name: 'ISO', cat: 'SUPLEMENTO', qty: 1, price: 6 },
      { id: 'h2o', name: 'AGUA', cat: 'BEBIDA', qty: 1, price: 1.5 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 14, 15),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 14, 25),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 14, 35),
    total: 11.00,
    items: [
      { id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 },
      { id: 'nitro', name: 'NITRO', cat: 'SUPLEMENTO', qty: 1, price: 4 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 14, 45),
    total: 5.00,
    items: [{ id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 }]
  },

  // 15:00 checkins (12 checkins)
  {
    id: `v_${vCounter++}`,
    customer: 'LUIS',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 2),
    total: 5.00,
    items: [{ id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 7),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 12),
    total: 0.00,
    items: [{ id: 'entrada-socio', name: 'ENTRADA SOCIO', cat: 'ENTRADA', qty: 1, price: 0 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 17),
    total: 9.50,
    items: [
      { id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 },
      { id: 'fury', name: 'FURY', cat: 'BEBIDA', qty: 1, price: 2.5 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 22),
    total: 5.00,
    items: [{ id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 27),
    total: 5.00,
    items: [{ id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 }]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'KIMBERLY CHAVARRIA',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 32),
    total: 0.00,
    items: [{ id: 'entrada-socio', name: 'ENTRADA SOCIO', cat: 'ENTRADA', qty: 1, price: 0 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 37),
    total: 9.00,
    items: [
      { id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 },
      { id: 'mitadnitra', name: 'MITAD NITRA', cat: 'PRE-ENTRENO', qty: 1, price: 4 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 42),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'EMI VALERIANO',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 47),
    total: 0.00,
    items: [{ id: 'entrada-socio', name: 'ENTRADA SOCIO', cat: 'ENTRADA', qty: 1, price: 0 }]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'ANGEL VASQUEZ',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 52),
    total: 0.00,
    items: [{ id: 'entrada-socio-qr', name: 'Entrada Socio (QR)', cat: 'ENTRADA', qty: 1, price: 0 }]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'DAVIS LAGUNA',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 15, 57),
    total: 110.00,
    items: [
      { id: 'entrada-socio-qr', name: 'Entrada Socio (QR)', cat: 'ENTRADA', qty: 1, price: 0 },
      { id: 'mens1', name: 'MENS 1', cat: 'ADICIONAL', qty: 1, price: 110 }
    ]
  },

  // 16:00 checkins (2 checkins)
  {
    id: `v_${vCounter++}`,
    customer: 'ZAPANA',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 16, 15),
    total: 12.00,
    items: [
      { id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 },
      { id: 'mitadcbum', name: 'MITAD CBUM', cat: 'PRE-ENTRENO', qty: 1, price: 5 },
      { id: 'loacongas05l', name: 'LOA CON GAS 0.5L', cat: 'BEBIDA', qty: 1, price: 2 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 16, 45),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },

  // 17:00 checkins (6 checkins)
  {
    id: `v_${vCounter++}`,
    customer: 'ERICK',
    method: 'Yape',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 5),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 15),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 25),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 35),
    total: 0.00,
    items: [{ id: 'entrada-socio', name: 'ENTRADA SOCIO', cat: 'ENTRADA', qty: 1, price: 0 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 45),
    total: 7.00,
    items: [{ id: 'entrada', name: 'ENTRADA', cat: 'ENTRADA', qty: 1, price: 7 }]
  },
  {
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 17, 55),
    total: 0.00,
    items: [{ id: 'entrada-socio', name: 'ENTRADA SOCIO', cat: 'ENTRADA', qty: 1, price: 0 }]
  },

  // 18:00 checkins (2 checkins, plus 1 store sale)
  {
    id: `v_${vCounter++}`,
    customer: 'OMAR',
    method: 'Efectivo',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 18, 15),
    total: 2.50,
    items: [{ id: '360', name: '360', cat: 'BEBIDA', qty: 1, price: 2.5 }]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'MAX',
    ...
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 18, 35),
    total: 15.00,
    items: [
      { id: 'entrada-men', name: 'ENTRADA MENOR', cat: 'ENTRADA', qty: 1, price: 5 },
      { id: 'cbum', name: 'CBUM', cat: 'PRE-ENTRENO', qty: 1, price: 10 }
    ]
  },
  {
    id: `v_${vCounter++}`,
    customer: 'FATIMA IZAGUIRRE',
    method: 'QR',
    status: 'paid',
    date: todayD,
    datetime: getUTCDateTime(todayD, 18, 55),
    total: 0.00,
    items: [{ id: 'entrada-socio-qr', name: 'Entrada Socio (QR)', cat: 'ENTRADA', qty: 1, price: 0 }]
  }
];
...
console.log(`- Total monthly sales: S/ ${sumMes.toFixed(2)} (Expected: S/ 6446.50)`);
console.log(`- Membresias (MEMB): S/ ${incMembresias.toFixed(2)} (Expected: S/ 1315.00)`);
console.log(`- Suplementos (SUPL): S/ ${incSups.toFixed(2)} (Expected: S/ 340.00)`);
console.log(`- Bebidas (BEB): S/ ${incBebidas.toFixed(2)} (Expected: S/ 565.00)`);
console.log(`- Pre-entrenos (PRE): S/ ${incPreEntreno.toFixed(2)} (Expected: S/ 623.00)`);
console.log(`- Otros (OTROS): S/ ${incAdicional.toFixed(2)} (Expected: S/ 162.00)`);
console.log(`- Entradas (No in chart): S/ ${incEntradas.toFixed(2)} (Expected: S/ 3441.50)`);
...
const validationSucceeded = 
  Math.abs(sumMes - 6446.50) < 0.01 &&
  Math.abs(incMembresias - 1315.00) < 0.01 &&
  Math.abs(incSups - 340.00) < 0.01 &&
  Math.abs(incBebidas - 565.00) < 0.01 &&
  Math.abs(incPreEntreno - 623.00) < 0.01 &&
  Math.abs(incAdicional - 162.00) < 0.01 &&
  Math.abs(incEntradas - 3441.50) < 0.01 &&
  heatmapMatches;
